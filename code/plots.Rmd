...
sin.frac.by.type <- fread(file = 'output/sin_frac_by_type3.csv', header = TRUE, stringsAsFactors = FALSE)[order(type, yq)]

```

```{r plot number of managers}
plot <- ggplot(data= sin.frac.by.type, aes(x=yq, y=num.managers, group = factor(type)))+
...
plot <- ggplot(data= sin.frac.by.type, aes(x=yq, y=num.obs, group = factor(type)))+
    geom_line(aes(colour=factor(type)))+
    labs(color = "Investor Type") +
...
```{r plot sin}
plot <- ggplot(data= sin.frac.by.type, aes(x=yq,y=sin.frac.wei, group = factor(type)))+
    geom_line(aes(colour=factor(type)))+
    labs(color = "Investor Type") +
...
plot <- ggplot(data= sin.frac.by.type, aes(x=yq,y=sin.frac, group = factor(type)))+
    geom_line(aes(colour=factor(type)))+
    labs(color = "Investor Type") +
...
```
```{r plot fossil}
plot <- ggplot(data= sin.frac.by.type, aes(x=yq,y=fossil.frac.wei, group = factor(type)))+
    geom_line(aes(colour=factor(type)))+
    labs(color = "Investor Type") +
...
plot <- ggplot(data= sin.frac.by.type, aes(x=yq,y=fossil.frac, group = factor(type)))+
    geom_line(aes(colour=factor(type)))+
    labs(color = "Investor Type") +
